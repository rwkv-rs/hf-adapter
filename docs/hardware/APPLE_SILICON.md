...
- `bitsandbytes` quantization is not an Apple path. Native MM8/MM4 now has
  ...
  one-shot equality and aggregate round tok/s telemetry. Current long-context
