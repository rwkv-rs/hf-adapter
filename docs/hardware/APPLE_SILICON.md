...
7. Port the validated DPLR/WY chunk-summary, prefix-combine, and
   chunk-apply/output math to native MLX/Metal; then fuse WKV and W8/W4
   projection paths until prefill and quant speed gates pass end to end.
