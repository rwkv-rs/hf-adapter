...
2. Extend 1.5B beyond 10-step Trainer/TRL and prompt512/decode32 MLX sweep to
   >10-step Trainer/TRL, longer production-style decode, and memory-pressure notes.
