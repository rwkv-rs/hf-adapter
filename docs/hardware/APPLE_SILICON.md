...
- `bitsandbytes` quantization is not an Apple path. Native MM8/MM4 now has
  ...
  for safe W8 rows until the fused batch path is fixed. Current long-context
  ratio evidence still shows memory
