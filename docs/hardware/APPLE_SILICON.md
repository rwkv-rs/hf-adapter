...
4. Extend the MLX recurrent reference and `MLXGenerationSession` / batched session backend beyond the current
   0.1B prompt256/decode8, 0.4B/1.5B prompt4096/decode256 matrices, 0.4B 8-session repeat=2, and 1.5B 5-session repeat=4 rows to longer prompt distributions,
