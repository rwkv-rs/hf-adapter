...
7. Continue the now-working MLX/Metal DPLR/WY scaffold: tile/parallelize the
   summary kernel, support partial chunks, refactor real model prefill to
   layer-major execution, and then fuse WKV and W8/W4 projection paths until
   full-model prefill and quant speed gates pass end to end.
