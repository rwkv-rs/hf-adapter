...
| V100 | Albatross P1 plus 1.5B vs full-FLA Qwen3.5-2B B1/B8 raw prefill/decode minima `2.815921x/5.270432x`; active-work minima `2.285574x/4.277804x` | Selected-module W8/W4 decode `1.006x–1.128x` fp16; paired prefill `0.996x–1.007x`; full-memory quant open | Greedy/cache gates; Qwen and RWKV 32-token native-route probes pass | Production-close for measured lanes |
...
V100 evidence and boundaries:
[`v100_acceptance_20260716`](../bench/v100_acceptance_20260716/README.md).
