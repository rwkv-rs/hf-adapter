...
| RTX 4080 16GB, sm89 | **Production-close for measured Native HF and bsz8 lanes** | Native HF 0.4B/1.5B; 1.5B vs full-FLA Qwen3.5-2B; full-model BNB memory and output-head A8W8/W4 | exact 24-shape prefill policy; dense prefill/decode minima `1.024180x/1.435296x`; output-head quant complete-cell minima `1.005056x/1.026122x`; BF16 training compatibility smoke | task quality, long-run/distributed training, larger models and full-model quant speed |
...
- RTX 4080 Native HF and full-FLA Qwen: [`../bench/4080_ada_validation_20260719/README.md`](../bench/4080_ada_validation_20260719/README.md)
