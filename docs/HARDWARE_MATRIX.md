...
| RTX 5090, sm120 | **Production-close for measured Qwen/W4/train_temp lanes; Native performance partial** | Existing Qwen/W4/MATH lanes, single-GPU train_temp, Native HF Gradio 7.2B B1/B8 | Full-FLA Qwen 8/8; BN/TN W4 B1/B8; Native B16 train_temp exact/cohort/resume/memory gates; real Native UI generation | Native train throughput parity, Gradio speed/memory and sparse 8/8 greedy; broader quality/cards and distributed train_temp |
