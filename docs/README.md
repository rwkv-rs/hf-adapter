...
| Where is the tutorial for every implemented adaptation? | [`COMPLETE_ADAPTER_GUIDE.md`](COMPLETE_ADAPTER_GUIDE.md) / [`COMPLETE_ADAPTER_GUIDE_ZH.md`](COMPLETE_ADAPTER_GUIDE_ZH.md) |
...
| How do I use conversion, native/no-FLA, cache, batching, and chunked prefill? | [`INFERENCE_WORKFLOWS.md`](INFERENCE_WORKFLOWS.md) / [`INFERENCE_WORKFLOWS_ZH.md`](INFERENCE_WORKFLOWS_ZH.md) |
| How do I use PEFT, Trainer, resume, SFT, DPO, or GRPO? | [`TRAINING_WORKFLOWS.md`](TRAINING_WORKFLOWS.md) / [`TRAINING_WORKFLOWS_ZH.md`](TRAINING_WORKFLOWS_ZH.md) |
| How do I run W8/W4 instead of only reading quantization status? | [`QUANTIZATION_USAGE.md`](QUANTIZATION_USAGE.md) / [`QUANTIZATION_USAGE_ZH.md`](QUANTIZATION_USAGE_ZH.md) |
| How do I run Apple MPS, MLX, sessions, quant, or CoreML? | [`APPLE_USAGE.md`](APPLE_USAGE.md) / [`APPLE_USAGE_ZH.md`](APPLE_USAGE_ZH.md) |
