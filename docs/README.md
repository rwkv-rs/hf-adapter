...
| [`performance/BN_TN_TUNING.md`](performance/BN_TN_TUNING.md) | Scalar negative evidence, promoted RTX 5090 Tensor Core BN/TN contract, and V100 packed-MM4 decode profiles |
