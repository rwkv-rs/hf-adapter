...
- Batch conversion wrapper writes a SHA256 manifest and supports dry-run
  ...
  conversions; the 0.4B, 1.5B, and 2.9B checkpoints have now been converted and
