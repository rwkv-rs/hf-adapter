...
interleaved multi-session decode with repeat-pressure telemetry, and prompt/decode length sweep and repeat/pressure entry points including a 0.1B prompt256/decode8 repeat matrix.
