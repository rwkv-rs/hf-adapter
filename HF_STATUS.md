...
| Production performance | **PARTIAL / strong card-local closes** | V100, RTX 4090 all published 0.4B–7.2B/Qwen3.5 bsz8 pairs, RTX 5090 and Apple M5 have promoted artifacts; RTX 5070 1.5B RWKV vs full-FLA Qwen3.5 2B also passes its bsz8 gates in 18/18 cells |
