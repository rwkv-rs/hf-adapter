...
| 量化加载 | 大模型 V100 / A6000 功能通过 | bnb 8/4-bit 加载/生成、显存下降;0.4B/1.5B/2.9B/7.2B V100 与 RTX A6000 pass/pass;RTX A6000 另有 native mm8/mm4 decode telemetry 行;这些是功能/显存证据,不是量化速度达标;速度仍是生产缺口。 |
