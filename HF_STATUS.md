...
| Universal W8/W4 speed | **PARTIAL** | selected V100/4090/5090 speed lanes pass; V100 1.5B W4 `speed` now closes exact B1/B8 prompt128 all-phase gates at prefill `1.0180x/1.0024x`, decode `1.0293x/1.0012x` and footprint `0.9348x`, while full-memory W4/W8 prefill remains open. RTX 5090 g1h 1.5B/2.9B/7.2B/13.3B have all-phase exact-model Marlin W4 closes at `0.5298x–0.6250x` footprint; universal prefill/full-projection coverage remains open |
...
|---|---|---|
| V100 32GB | **Production-close for measured lanes** | Fixed-shape Native prefill graphs close the old 1.5B B1/B8 prompt128 wrapper regression at `1.048x/1.045x`; chunk512 ratios improve to B1 `0.4190/0.6332/0.8747x` and B8 `0.7584/0.9042/0.9665x` for chunks 64/128/256. W4 `speed` passes exact B1/B8 all-phase speed, memory, cosine, greedy and determinism gates. Packed MM4 cached decode also passes exact 1.5B/2.9B/7.2B profiles 7/7 each. Full-memory W4/W8 prefill is improved to best clean B1 rows `0.9166x/0.8514x` fp16 but remains open; [`bench/v100_native_prefill_graph_quant_20260719/`](bench/v100_native_prefill_graph_quant_20260719/README.md), [`bench/v100_sm70_mm4_bntn_20260716/`](bench/v100_sm70_mm4_bntn_20260716/README.md), [`bench/v100_active_b1b8_20260715/`](bench/v100_active_b1b8_20260715/README.md) |
