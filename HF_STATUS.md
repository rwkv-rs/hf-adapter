...
| Universal W8/W4 speed | **PARTIAL** | selected V100/4090/5090 speed lanes pass; fresh V100 1.5B W4 `balanced` B1/B8 prompt128 closes all-phase speed and memory at prefill `1.0108x/0.9986x`, decode `1.0345x/1.0037x`, footprint `0.9183x` and peak `0.9579x/0.9514x`. W8 `speed` is at fp16 speed with `0.9562x` footprint, but its graph peak is larger; full-memory W4 prefill remains open. RTX 5090 g1h 1.5B/2.9B/7.2B/13.3B have all-phase exact-model Marlin W4 closes at `0.5298x–0.6250x` footprint; universal prefill/full-projection coverage remains open |
...
|---|---|---|
| V100 32GB | **Production-close for measured lanes** | Fresh same-session 1.5B Native/Albatross B1/B2/B4/B8 is `0.9105x–1.0616x` decode and `0.9205x–1.1110x` prefill at prompt128/512, with correctness passing. Dynamic B8→B2 reaches graph-cache hit rate `1.0`; chunk512 ratios span B1 `0.4192/0.6279/0.8705/1.0017x` and B8 `0.7715/0.9095/0.9677/0.9937x` for chunks 64/128/256/512. W4 `balanced` passes exact B1/B8 all-phase speed, footprint, peak, cosine, greedy and determinism gates. Full-memory W4 prefill remains `0.8992x/0.9533x`; W8 reduces footprint but not graph peak. [`bench/v100_pr58_final_20260719/`](bench/v100_pr58_final_20260719/README.md), [`bench/v100_sm70_mm4_bntn_20260716/`](bench/v100_sm70_mm4_bntn_20260716/README.md), [`bench/v100_active_b1b8_20260715/`](bench/v100_active_b1b8_20260715/README.md) |
