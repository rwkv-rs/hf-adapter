...
| Trainer / TRL | **PASS for compatibility matrix; train_temp exact lanes accepted** | Trainer, SFT, DPO and GRPO smoke; RTX 5090 BF16 12x768 B1 plus Native B16/T512 backward/step exact, 3-seed x 1,000-step cohort and checkpoint-resume gates pass |
...
| Native/no-FLA backend | **PASS for HF compatibility, exact training, and measured 5090 decode** | load/generate/cache/PEFT/Trainer/TRL and Native B16/T512 train_temp gates pass; exact 5090/7.2B FP32-state decode is `1.0041x/1.0045x` precision-matched v3a at B1/B8 with logits/top-1 gates, while training remains `0.9499x` official and broader performance is card-local |
...
| RTX 5090 | **Production-close for measured Qwen/W4/train_temp/Native-decode lanes** | Native B16/T512 train_temp passes exact tensors, 3-seed convergence, resume and steady-memory gates at `0.9499x` official. The opt-in 7.2B FP32-state Native decode lane now passes B1/B8 precision-matched v3a at `1.0041x/1.0045x`, three 512-token repeats, active-extension and logits/top-1 gates. [`bench/5090_native_decode_fused_20260718/`](bench/5090_native_decode_fused_20260718/README.md), [`bench/5090_native_train_temp_b16_20260718/`](bench/5090_native_train_temp_b16_20260718/README.md), [`bench/5090_bntn_all_models_20260716/`](bench/5090_bntn_all_models_20260716/README.md) |
...
2. Extend the exact RTX 5090 Native decode close to prefill, more checkpoints,
   more cards and the faster official fp16-state lane; retain same-card
   Albatross P2/P3 for larger models.
3. Add H100, AMD/ROCm and Turing evidence.
4. Complete broader Apple-family, CoreML INT4/ANE and formal quality coverage.
5. Extend the accepted single-5090 B1/B16 train_temp lanes to larger models,
   real datasets, multi-day runs, additional cards and distributed training;
   extend ZeRO-3 optimizer/scheduler/RNG resume evidence.
