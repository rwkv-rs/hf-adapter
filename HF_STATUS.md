...
|---|---|---|
| V100 32GB | **Production-close for measured lanes** | Dense Albatross P1 and selected-module W8/W4 speed pass; the current 1.5B/full-FLA-Qwen3.5-2B target-only B1/B8 artifact passes raw prefill/decode minima `2.815921x/5.270432x` and active-work minima `2.285574x/4.277804x`, with 32-token route probes. Full-memory quant and broader full-FLA shapes remain open; older Torch-fallback matrices are diagnostics only; [`bench/v100_acceptance_20260716/`](bench/v100_acceptance_20260716/README.md) |
