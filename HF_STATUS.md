...
| Native/no-FLA backend | **PASS for HF compatibility and exact training lanes; performance partial** | load/generate/cache/PEFT/Trainer/TRL, official-shell B16/T512/ZeRO-2 and real Gradio smoke pass; 5090 7.2B Native Gradio remains slower/heavier than official v3a and sparse greedy is 6/8 |
...
| RTX 5090 | **Production-close for measured Qwen/W4/train_temp lanes; Native Gradio partial** | Existing inference/training lanes remain. The official Space now runs through Native HF, but 7.2B FP16 reaches only `0.6859x/0.7743x` official v3a speed at B1/B8 and uses more process memory; sparse direct greedy is 6/8, so it stays opt-in. [`bench/5090_native_hf_gradio_train_temp_20260718/`](bench/5090_native_hf_gradio_train_temp_20260718/README.md), [`bench/5090_train_temp_alignment_20260717/`](bench/5090_train_temp_alignment_20260717/README.md), [`bench/5090_bntn_all_models_20260716/`](bench/5090_bntn_all_models_20260716/README.md) |
