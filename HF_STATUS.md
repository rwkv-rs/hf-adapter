...
| Apple Silicon / MPS | 初始可跑 | 见 [`docs/hardware/APPLE_SILICON.md`](docs/hardware/APPLE_SILICON.md):native/no-FLA 安装、MPS probe、0.1B/0.4B smoke、tiny train/PEFT/Trainer、0.1B/0.4B PEFT LoRA/Trainer/SFT/DPO/GRPO 命令、0.4B generation sweep 到 512、1.5B fp16 inference/sweep 到 512 和 fp32 manual/Trainer/TRL PEFT LoRA 1/2/3-step 行、RafaelUI MLX/Metal 后续参考。 |
