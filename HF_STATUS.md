...
| Validated W8/W4 speed lanes | **PASS for measured profiles** | V100 MM4 closes 1.5B/2.9B/7.2B cached-decode profiles 7/7 each; RTX 4080 output-head A8W8/W4 paired lanes pass complete-cell speed and correctness gates; RTX 5090 g1h 1.5B/2.9B/7.2B/13.3B pass all-phase exact-model Marlin W4 at `0.5298x–0.6250x` footprint |
...
| RTX 4080 | **Production-close for measured Native HF and bsz8 lanes** | Exact 0.4B/1.5B native prefill policy and HF API/training smokes pass. The 1.5B/full-FLA-Qwen3.5-2B matrix has dense prefill/decode minima `1.024180x/1.435296x`; output-head A8W8/W4 complete-cell minima are `1.005056x/1.026122x` with lower footprint and greedy/cosine gates. Full BNB8/4 are memory-only routes; task quality and long-run training are not covered; [`bench/4080_ada_validation_20260719/`](bench/4080_ada_validation_20260719/README.md) |
