...
| Native/no-FLA backend | **PASS for HF compatibility and exact training lanes; performance partial** | load/generate/cache/PEFT/Trainer/TRL plus Native B16/T512 train_temp exact/cohort/resume gates pass; 5090 training throughput is `0.9499x` official, and 7.2B Native Gradio remains slower/heavier than v3a with sparse greedy 6/8 |
...
| RTX 5090 | **Production-close for measured Qwen/W4/train_temp lanes; Native performance partial** | Native B16/T512 train_temp passes exact tensors, 3-seed convergence, 500+500 resume and zero-growth steady-memory gates, but median throughput is `0.9499x` official. Native 7.2B Gradio also remains slower/heavier than v3a and sparse greedy is 6/8. [`bench/5090_native_train_temp_b16_20260718/`](bench/5090_native_train_temp_b16_20260718/README.md), [`bench/5090_native_hf_gradio_train_temp_20260718/`](bench/5090_native_hf_gradio_train_temp_20260718/README.md), [`bench/5090_bntn_all_models_20260716/`](bench/5090_bntn_all_models_20260716/README.md) |
