...
| RTX 5090 | **Production-close existing artifact; new Qwen matrix partial** | Quant pressure, prior 13.3B low-memory conversion and full MATH500 remain promoted. The new full-FLA Qwen3.5 B1/B8 matrix passes its six checked 0.4B/1.5B/2.9B batch-pairs (108 candidate + 108 verified full-FLA references), while 7.2B/9B and the fresh official 13.3B run remain open; [`bench/5090_blackwell_production_close_20260712/`](bench/5090_blackwell_production_close_20260712/README.md), [`bench/5090_g1h_qwen35_b1_b8_20260715/`](bench/5090_g1h_qwen35_b1_b8_20260715/README.md) |
