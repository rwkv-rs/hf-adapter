...
| DeepSpeed ZeRO | ZeRO2/3 base + ZeRO2 resume | ZeRO-2/3 HF Trainer smoke 通过;ZeRO2 checkpoint resume 已在 A100 40GB 验证到 7.2B;ZeRO3 resume 待修。 |
...
- **ZeRO3 checkpoint resume** 仍待修;ZeRO2 resume 已在 A100 40GB 验证到 7.2B。
...
- 更多卡覆盖(Turing / H100 / 5090 / AMD)与更长训练吞吐。
