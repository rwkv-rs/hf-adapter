...
| Trainer / TRL | 大模型 V100 smoke 已补 | 0.4B/1.5B Trainer/SFT/DPO/GRPO 通过;2.9B native SFT/DPO/GRPO 通过;7.2B 受 V100 显存限制;13.3B 推理对齐+decode 速度已验(单卡 V100-32GB fp16,native_jit 18.4 tok/s,1.58× fla),训练需 >32GB。 |
...
| 跨卡验证 | 部分 | V100 基线已加强;A100 0.1B smoke/bench/quant/bf16 training/ZeRO2/3 已补;4090/H100/AMD 等仍需贡献。 |
...
| A100 / Ampere | 已补 0.1B 基础验证 | 2026-07-02:1×A100 fp16/bf16 smoke、batch sweep、8/4-bit quant;2×A100 bf16 Trainer ZeRO-2/3。继续补更大模型与吞吐矩阵。 |
...
- 更多卡覆盖(4090 / H100 / 5090 / Pascal / AMD),以及 A100 更大模型/更长训练吞吐。
