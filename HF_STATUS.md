...
| Production performance | **PARTIAL / strong card-local closes** | V100, measured 4090 lanes, RTX 5090 and Apple M5 have promoted artifacts |
...
|---|---|---|
| V100 32GB | **Production-close** | Dense Albatross P1 plus native W8/W4 speed lane; Qwen3.5 HF matrix passes 216/216 cells across 1.5B/2.9B/7.2B pairs; [`bench/v100_production_close_20260711/`](bench/v100_production_close_20260711/README.md), [`bench/v100_qwen35_full_matrix_20260713/`](bench/v100_qwen35_full_matrix_20260713/README.md) |
...
| GTX 1080 Ti / RTX 5070 Laptop | **Smoke** | compatibility evidence, not full production-close |
