...
def plan_row(
    *,
    ...
    return {
        ...
        "stateful_prefill_implemented": bool((manifest_function(manifest, "prefill") or {}).get("implemented")),
        "stateful_decode_implemented": bool((manifest_function(manifest, "decode") or {}).get("implemented")),
        "state_names": state_names(manifest),
