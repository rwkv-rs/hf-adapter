...
| RWKV-7 与 Qwen3.5 最新速度及复现 | [Prefill/Decode 对比](docs/QWEN35_LATEST_P_D_TOKPS.md)与[独立 GPU 速度复现教程](docs/QWEN35_SPEED_REPRODUCTION_ZH.md)（[English](docs/QWEN35_SPEED_REPRODUCTION.md)） |
