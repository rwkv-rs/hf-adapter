...
- 把 MLX recurrent reference 从短 0.1B/0.4B/1.5B row 扩到长 prompt/长 decode、memory-pressure 遥测、可复用 tokenizer-integrated generate API;
