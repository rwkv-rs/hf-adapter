...
- Apple native MM8/MM4 功能/min-params smoke 和初始 MLX packed W8/W4 affine dequant-matmul path 已有;生产级 W8/W4 仍需要 Metal fused projection/WKV kernel 和端到端速度超过 fp16 的证据。
