...
- 把 MLX recurrent reference/session helper 继续扩到 1.5B 更长 prompt/长 decode、0.4B/1.5B 更高并发/更长 repeat 的 memory-pressure 遥测;
