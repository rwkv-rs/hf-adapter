...
已完成首批 M5/16GB 证据:0.1B load/forward/generate、tiny native train、tiny PEFT/Trainer、0.1B 真模型 PEFT LoRA backward + HF Trainer。继续补:

- 运行并记录 0.1B TRL SFT / DPO 可行性 smoke;
