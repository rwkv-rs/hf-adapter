...
1. 支持全部已发布尺寸的配置推断和转换：0.4B / 1.5B / 2.9B / 7.2B / 13.3B。
   ...
   - 真实 0.4B / 1.5B / 2.9B / 7.2B `.pth` 已完成转换、load、forward、generate smoke，并加入 regression gate；下一步继续 13.3B+、official alignment 和 speed smoke。
